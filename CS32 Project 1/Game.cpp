...
//Have the Game recognize the new h command, tell the City's history object to display the history grid, 
//and then print the Press enter to continue. prompt and wait for the user to respond. (cin.ignore(10000,'\n'); does that nicely.) 
